...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(CustomException exceptions) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(CustomException exceptions)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({CustomException exceptions});
}
...
class _$FailureImpl<T> implements Failure<T> {
  const _$FailureImpl({required this.exceptions});

  @override
  final CustomException exceptions;
...
abstract class Failure<T> implements ApiResult<T> {
  const factory Failure({required final CustomException exceptions}) =
      _$FailureImpl<T>;

  CustomException get exceptions;
  @JsonKey(ignore: true)
  _$$FailureImplCopyWith<T, _$FailureImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
